...
export const SignupPage: React.FC = () => {
  ...
  return (
    <div className="auth-page-container">
      ...
      <div className="auth-form-side">
        <div style={{ marginBottom: '2rem' }}>
          <button
            ...
            className="btn-ghost"
            style={{ padding: '6px 0', display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '1.25rem' }}
          >
            <ArrowLeft size={16} />
        ...
        <p style={{ color: 'var(--neutral-slate)', fontSize: '0.95rem', marginBottom: '1.75rem' }}>
        ...
        <p style={{ textAlign: 'center', marginTop: '1.75rem', fontSize: '0.9rem', color: '#A1A1AA' }}>
      ...
      {/* Right Column: Purple dunes graphic */}
